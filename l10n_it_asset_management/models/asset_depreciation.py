...
class AssetDepreciation(models.Model):
    ...
    company_id = fields.Many2one(
        "res.company", readonly=True, related="l10n_it_asset_id.company_id", string="Company"
    )

    currency_id = fields.Many2one(
        "res.currency", readonly=True, related="l10n_it_asset_id.currency_id", string="Currency"
    )
    ...
    def get_dismiss_account_move_vals(self):
        ...
        return {
            ...
            "date": self._context.get("dismiss_date") or self.l10n_it_asset_id.sale_date,
