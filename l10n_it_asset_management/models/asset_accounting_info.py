...
class AssetAccountingInfo(models.Model):
    ...
    l10n_it_asset_id = fields.Many2one("asset.asset", ondelete="set null", string="Asset")
    ...
    def check_data_coherence(self):
        ...
        if (
            ...
            and self.l10n_it_asset_id != self.dep_line_id.depreciation_id.l10n_it_asset_id
        ):
